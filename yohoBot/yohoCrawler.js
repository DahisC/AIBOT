...
function crawler(searchRange, index, searchCallback, displayFunc) {
	...
	function (e, r, b) {
		...
		productClassC = productClassC.replace(/電視機/g,"");
		productClassC = productClassC.replace(/冷氣機/g,"");
		productClassC = productClassC.replace(/洗衣機/g,"");
		productClassC = productClassC.replace(/雪櫃/g,"");
		productClassC = productClassC.replace(/乾衣機/g,"");
		productClassC = productClassC.replace(/電熱水爐/g,"");
		productClassC = productClassC.replace(/抽油煙機/g,"");
		...
		productClassC = productClassC.replace(/浴室寶/g,"");
		...
		productClassC = productClassC.replace(/衣車/g,"");
		productClassC = productClassC.replace(/抽氣扇/g,"換氣扇");
		productClassC = productClassC.replace(/雪糕機/g,"");
		productClassC = productClassC.replace(/紅酒櫃/g,"");
		productClassC = productClassC.replace(/香薰機/g,"");
		...
		productClassC = productClassC.replace(/傳真機/g,"");
		productClassC = productClassC.replace(/電筒/g,"");
		productClassC = productClassC.replace(/鬧鐘/g,"");
		...
		productClassC = productClassC.replace(/電競椅/g,"");
		...
		productClassC = productClassC.replace(/單車/g,"");
		...
		productClassC = productClassC.replace(/數據卡/g,"");
		productClassC = productClassC.replace(/行李箱/g,"");
		productClassC = productClassC.replace(/頸枕/g,"");
