...
function crawler(searchRange, index, searchCallback, displayFunc) {
	...
	function (e, r, b) {
		...
		var productName = $('dt.product_name h1').text();
			...
			productName = productName.replace(/風筒/g, "吹風機");
			productName = productName.replace(/外置硬碟/g, "外接硬碟");
			productName = productName.replace(/手提電話/g, "手機");
			productName = productName.replace(/智能手機/g,"智慧型手機");
			productName = productName.replace(/數據線/g,"傳輸線");
			productName = productName.replace(/自拍神棍/g,"自拍棒");
			productName = productName.replace(/錄音筆/g,"麥克風");
			productName = productName.replace(/耳擴/g,"行動耳擴");
			productName = productName.replace(/虛擬現實頭盔/g,"VR頭戴顯示器");
			productName = productName.replace(/航拍攝影機/g,"空拍無人機");
			productName = productName.replace(/即影即有相機/g,"拍立得相機");
			productName = productName.replace(/監控攝影機/g,"監視攝影機");
			productName = productName.replace(/手持穩定器/g,"相機穩定器");
			productName = productName.replace(/單鏡反光相機/g,"單眼相機");
			productName = productName.replace(/相機袋/g,"相機包");
			productName = productName.replace(/數碼攝錄機/g,"數位攝影機");
			productName = productName.replace(/相機配件/g,"相機配件");
			productName = productName.replace(/產品攝影棚/g,"簡易攝影棚");
			productName = productName.replace(/電子防潮箱/g,"防潮箱");
			productName = productName.replace(/防潮箱/g,"防潮箱");
			productName = productName.replace(/無反相機/g,"無反光單眼");
			productName = productName.replace(/洗面機/g,"洗臉機");
			productName = productName.replace(/導入導出機/g,"導入導出儀");
			productName = productName.replace(/噴霧保濕器/g,"噴霧保濕器");
			productName = productName.replace(/電動剃鬚刨/g,"電動刮鬍刀");
			productName = productName.replace(/睫毛捲曲器/g,"睫毛捲曲器");
			productName = productName.replace(/電動修眉器/g,"修眉器");
			productName = productName.replace(/風筒/g,"吹風機");
			productName = productName.replace(/水牙線機/g,"洗牙機");
			productName = productName.replace(/脫毛機/g,"除毛機");
			productName = productName.replace(/光學美容機/g,"光學美容機");
			productName = productName.replace(/微電流機/g,"微電流裝置");
			productName = productName.replace(/RF射頻機/g,"RF射頻裝置");
			productName = productName.replace(/吸塵機/g,"吸塵器");
			productName = productName.replace(/風扇/g,"電風扇");
			productName = productName.replace(/空氣清新機/g,"空氣清淨機");
			productName = productName.replace(/抽濕機/g,"除濕機");
			productName = productName.replace(/掃地機械人/g,"掃地機器人");
			productName = productName.replace(/加濕機/g,"加濕器");
			productName = productName.replace(/抹窗機械人/g,"洗窗機器人");
			productName = productName.replace(/電暖氈/g,"電熱毯");
			productName = productName.replace(/暖風機/g,"暖風扇");
			productName = productName.replace(/電熱水煲/g,"電子鍋");
			productName = productName.replace(/電飯煲/g,"電子鍋");
			productName = productName.replace(/榨汁機/g,"果汁機");
			productName = productName.replace(/焗爐/g,"電烤箱");
			productName = productName.replace(/蒸焗爐/g,"蒸氣烤箱");
			productName = productName.replace(/攪拌機/g,"攪拌裝置");
			productName = productName.replace(/多士爐/g,"電烤箱");
			productName = productName.replace(/TVBox/g,"電視盒");
			productName = productName.replace(/藍光機/g,"藍光播放機");
			productName = productName.replace(/手提電腦/g,"筆記型電腦");
			productName = productName.replace(/平板電腦/g,"平板電腦");
			productName = productName.replace(/桌上電腦/g,"桌上型電腦");
			productName = productName.replace(/迷你電腦/g,"桌上型電腦");
			productName = productName.replace(/流動相片打印機/g,"行動相片列印機");
			productName = productName.replace(/3D打印機/g,"3D列印機");
			productName = productName.replace(/多合一打印機/g,"多合一事務機");
			productName = productName.replace(/汽車空氣清新機/g,"汽車空氣濾淨器");
			productName = productName.replace(/死火過江龍/g,"引擎熄火過電器");
			productName = productName.replace(/雷達測速器/g,"雷達探測器");
